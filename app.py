...
if __name__ == '__main__':
    ...
    # if NEED_IMPORT:
        # tmp = db.session.query(Recipe).filter(Recipe.recipe_id==6).first()
        # print(tmp.recipe_name, tmp.list_ingredients)
        # for el in tmp.list_ingredients:
        #     print(el.ingredient_name)
